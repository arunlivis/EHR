...
'Initial exam screen 1' : function (browser){
  ...
  browser
  .useXpath()
  .click("//*[@id='initialexamscreen1']/div[4]/div[2]/div[1]/label["+a+"]")
  for(z=0; z<3; z++){
    b=Math.floor((Math.random()*5)+1)
    gait.push(b)
    browser
  .click("//*[@id='initialexamscreen1']/div[5]/div[2]/div[1]/label["+b+"]")
}
browser
.pause(300)
.useXpath()
  .click("//*[@id='initialexamscreen1']/div[4]/div[4]/div[1]/label["+c+"]")
  .click("//*[@id='initialexamscreen1']/div[5]/div[4]/div/label["+d+"]")
  .click("//*[@id='initialexamscreen1']/div[6]/div[2]/div[1]/div/label["+e+"]")
  .click("//*[@id='initialexamscreen1']/div[7]/div[2]/div[1]/div/label["+f+"]")
  .click("//*[@id='initialexamscreen1']/div[6]/div[4]/div[1]/label["+g+"]")
  .click("//*[@id='initialexamscreen1']/div[7]/div[4]/div[1]/label["+h+"]")
  .useCss()
  ...
  .pause(500)
     ...
     browser
     .useXpath()
     .click("//*[@id='initialexamscreen1']/div[10]/div/div[2]/div[1]/div/label["+j+"]")
     .useCss()
     ...
     .useXpath()
     .click("//*[@id='initialexamscreen1']/div[13]/div[2]/div[1]/label["+k+"]")
     for(z=0; z<3; z++){
     ...
     browser
     .useXpath()
     .click("//*[@id='initialexamscreen1']/div[14]/div[2]/div[1]/label["+l+"]")
   }
          if(l==6){
            browser
            .useXpath()
     ...
     browser
     .useXpath()
     .click("//*[@id='initialexamscreen1']/div[16]/div[2]/div[1]/label["+m+"]")
   }
           if(m==5){
            browser
            .useXpath()
    ...
    browser
    .useXpath()
    .click("//*[@id='initialexamscreen1']/div[18]/div[2]/div[1]/label["+n+"]")
  }
           if(n==6){
            browser
            .useXpath()
     ...
     browser
     .useXpath()
     .click("//*[@id='initialexamscreen1']/div[22]/div[2]/div[1]/label["+p+"]")
     .click("//*[@id='initialexamscreen1']/div[23]/div[2]/div[1]/div/label["+q+"]")
     .useCss()
     .clearValue('#shootDownYourArmLegTo_id')
     .setValue('#shootDownYourArmLegTo_id' , 'arm to leg')
     .useXpath()
     .click("//*[@id='initialexamscreen1']/div[24]/div[2]/div[1]/label["+r+"]")
     s=Math.floor((Math.random()*3)+1)
     browser
     .useXpath()
     .click("//*[@id='initialexamscreen1']/div[25]/div[2]/div[1]/label["+s+"]")
             if(s==3){
     ...
     browser
     .useXpath()
     .click("//*[@id='initialexamscreen1']/div[26]/div[2]/div[1]/label["+t+"]")
     .click("//*[@id='initialexamscreen1']/div[27]/div[2]/div[1]/label["+u+"]")  
             for(z=0; z<3; z++){
     ...
     .useXpath()
     .pause(500)
     .getLocationInView("//*[@id='initialexamscreen1']/div[34]/button[1]")
     .pause(500)
     .useCss()
     .getLocationInView('#gettingWorseOrBetterBetter_id')
     .pause(500)
     .useXpath()
     .click("//*[@id='initialexamscreen1']/div[29]/div[2]/div[1]/label["+v+"]")
   }
             if(v==4){
              browser
              .useXpath()
     ...
     .getLocationInView('#conditionAffectedYourDailyWork_id')
     .useXpath()
     .click("//*[@id='initialexamscreen1']/div[34]/button[1]")
  //-------------------
     browser
     .useXpath()
     ...
     .click("//*[@id='treatmentformsContent']/div/a[text()='Initial Exam Screen 1 -']")
      ...
      .pause(1000)
        ...
        browser
        .useXpath()
        .getLocationInView("//*[@id='sex_id']")
        .pause(500)
       //.examform1(appearance,b1,weight,posture,head,visceral,rombergs,cn,i1,begin,episode,l1,m1,n1,o1,constant,pain_shoot,describe,worse_in,condition,working,v1, oth1, oth2, oth3, oth4, oth5, oth6, oth7, hei_1, wei_1, tem_1, bbpp_1, pul_1)

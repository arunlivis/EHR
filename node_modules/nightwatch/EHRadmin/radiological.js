...
'Radiological' : function (browser){
  ...
  browser
        ...
        for(i=0; i<3; i++){
         ...
         browser
         .useXpath()
        .click("//*[@id='formid']/div/div[3]/div[2]/div[1]/label["+a+"]")
    }
    browser
    .useCss()
    .pause(500)
    ...
    cer2.push(e)
       browser
       .useXpath()
       .click("//*[@id='formid']/div/div[6]/div[3]/div/label["+c+"]")
       .click("//*[@id='formid']/div/div[8]/div[2]/div/label["+d+"]")
       .click("//*[@id='formid']/div/div[9]/div[2]/div[1]/label["+e+"]")
...
.pause(500)
    .useXpath()
    .click("//*[@id='formid']/div/div[14]/div[2]/div/label["+g+"]")
    .click("//*[@id='formid']/div/div[15]/div[2]/div/label["+h+"]")
    .click("//*[@id='formid']/div/div[16]/div[2]/div/label["+j+"]")
    .click("//*[@id='formid']/div/div[17]/div[2]/div/label["+k+"]")
    .click("//*[@id='formid']/div/div[18]/div[2]/div/label["+l+"]")
    .pause(1000)
    .useCss()
    ...
    for(i=0; i<3; i++){
      ...
      browser
      .useXpath()
      .click("//*[@id='formid']/div/div[21]/div[2]/div[1]/label["+m+"]")
    }
...
.pause(500)
       .useXpath()
       .click("//*[@id='formid']/div/div[25]/div[2]/div[1]/label["+p+"]")
       .pause(500)
       .useCss()
       ...
       .pause(500)
       .useXpath()
       .click("//*[@id='formid']/div/div[31]/div[2]/div/label["+q+"]")
       .click("//*[@id='formid']/div/div[32]/div[2]/div/label["+r+"]")
       .pause(500)
       .useCss()
       .getLocationInView('#lumbarNarrowedDisc1')
       .pause(500)
       ...
       s=Math.floor((Math.random()*3)+1)
        lumbar_view.push(s)
         browser
         .useXpath()
         .click("//*[@id='formid']/div/div[35]/div[2]/div[1]/label["+s+"]")
       }
       browser
       .useCss()
       .pause(500)
    ...
    .useCss()
       ...
       .pause(500)       
       .useXpath()
       .click("//*[@id='formid']/div/div[37]/div[4]/div/label["+w+"]")
       .click("//*[@id='formid']/div/div[38]/div[4]/div/label["+x+"]")
       .click("//*[@id='formid']/div/div[39]/div[2]/div/label["+y+"]")
       .click("//*[@id='formid']/div/div[40]/div[2]/div[1]/label["+z+"]")
       .useCss()
       .pause(500)
        ...
        .pause(500)
        .useXpath()
      .click("//*[@id='formid']/div/div[45]/div[2]/div/label["+za+"]")
         if(za==3){
          browser
          .useCss()
         ...
         .useXpath()
         .pause(500)
       .click("//*[@id='formid']/div/div[45]/div[5]/div/label["+zb+"]")
       .useCss()
       .pause(500)
    ...
    .useCss()
       ...
       .pause(1000)
       .useXpath()
       .click("//*[@id='formid']/div/div[46]/div[2]/div[1]/label["+zf+"]")    
         if(zf==6){
            browser
           .useCss()
          ...
          browser
          .useXpath()
       .click("//*[@id='formid']/div/div[47]/div[2]/div/label["+zg+"]")       
       .click("//*[@id='formid']/div/div[49]/div[2]/div/label["+zh+"]")       

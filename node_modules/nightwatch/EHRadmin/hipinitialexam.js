...
'Treatment Plan 2' : function (browser){
 ...
 'hip exam' : function (browser){
  browser
        .pause(2000)
        .useXpath()
        .waitForElementVisible("//*[@id='treatmentformsContent']/div/a[text()='Hip Initial Exam -']" , 60000)
        .pause(500)
      ...
      browser
        .useXpath()
        .click("//*[@id='formid']/div[3]/div[3]/label")
        .click("//*[@id='formid']/div[4]/div[3]/label")
        .click("//*[@id='formid']/div[3]/div[6]/label")
         ...
         browser
         .useXpath()
         .click("//*[@id='formid']/div[5]/div[4]/div[1]/label["+AOX+"]")
         ...
         if(d<=8){
           browser
           .useXpath()
           .click("//*[@id='formid']/div[8]/div[3]/div/label["+d+"]")
         }
         if(d==9){
           browser
           .useXpath()
         ...
         for(i=0; i<3; i++){
            ...
            browser
            .useXpath()
            .click("//*[@id='formid']/div[11]/div[2]/div[1]/label["+f+"]")
            .click("//*[@id='formid']/div[11]/div[4]/div[1]/label["+g+"]")
            .click("//*[@id='formid']/div[12]/div[2]/div[1]/label["+h+"]")
            .click("//*[@id='formid']/div[12]/div[4]/div[1]/label["+j+"]")
         }
...
//-----------------------------------------------------------------------------------------------------------------------------
 browser
        .useXpath()
        .pause(500)
        .getLocationInView("//*[@id='formid']/div[18]/div[9]/div[29]/button[1]")
        .pause(500)
        .useCss()
        .getLocationInView('#walking')
        .pause(500)
        .useXpath()
        .click("//*[@id='formid']/div[18]/div[9]/div[29]/button[1]")      

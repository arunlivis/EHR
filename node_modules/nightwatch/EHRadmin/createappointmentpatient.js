...
'View Appointments':function(browser){
	browser
       .useXpath()
       ...
       .waitForElementVisible('td[class="fc-widget-content"]' , 60000)
       .pause(500)
},
'Create New Patient by Appointment':function(browser){
...
appointmentDescription=af[Math.floor(Math.random()*af.length)]
	...
	browser
	   .pause(1000)
	   .useCss()
	   .click('td[class="fc-widget-content"]')
	   .waitForElementVisible('#addAppointmentModal' , 60000)
	   .pause(500)
	   .click('#newPatientTypeLabel')
	   .pause(800)
	   .click('#eventUrl-addName')
	   .pause(500)
	   .verify.visible('#newPatientFirstName_error')
	   .verify.visible('#newPatientLastName_error')
	   .verify.visible('#addAppointmentTime_error')
	   .pause(500)
	   .clearValue('#newPatientFirstName')
	   .setValue('#newPatientFirstName' ,firstname)
	   .clearValue('#newPatientLastName')
	   .setValue('#newPatientLastName' ,lastname)
	   .pause(500)
       ...
       .click('#eventUrl-addName')
       .pause(1000)
       .waitForElementNotVisible('#addAppointmentModal' , 60000, function(result){
       	browser
       .pause(500)
...
'Appointment Check': function(browser){
	browser
	  .useCss()
	  .pause(500)
		  .click('a[onclick="loadDatatable()"][href="#appointments"]')
		  .useXpath()
		  .waitForElementVisible("//*[@id='appointment']/tbody/tr/td[2]" , 60000)
		  .pause(1000)
		  .verify.containsText("//*[@id='appointment']/tbody/tr/td[4]" , appointment_1)
		  .pause(500)
		  .end()
}
}
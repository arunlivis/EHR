...
'Elbow exam':function(browser){	
   browser   
        ...
        not_1=['dominantHandLeft' , 'dominantHandRight']
        not_2=['bicepsBrachiiLeft' , 'bicepsBrachiiRight']
        not_3=['tricepsBrachiiLeft' , 'tricepsBrachiiRight']
        not_4=['commonFlexorsLeft' , 'commonFlexorsRight']
        not_5=['pronatorTeresLeft' , 'pronatorTeresRight']
        not_6=['anconeusLeft' , 'anconeusRight']
        not_7=['commonExtensorsLeft' , 'commonExtensorsRight']
        browser
        .useCss()
        ...
        .click('input[name="'+not_7[h-1]+'"][value="1"]')

...
'Hippa Notice of Privacy Practices':function(browser){
    browser
	   .click('a[onclick="getDefaultFormList();"]')
	   .useXpath()
	   .waitForElementVisible("//*[@id='formsContent']/div/div/a[text()='Hippa Notice of Privacy Practices']" , 60000)
	   .pause(500)
	   .useCss()
	        .getText('button[class="btn btn-primary btn-xs tooltipsclass"]' , function(result){
	   	             browser
                         .useXpath()
                          .pause(500)
                          .click("//*[@id='formsContent']/div/div/a[text()='Hippa Notice of Privacy Practices']")
...
'Fill Form': function(browser){
	browser
	   .useCss()
	   .waitForElementVisible('#patientNameId' , 60000)
	   .pause(500)
	   ...
	   .useXpath()
       .pause(500)
       .verify.elementNotPresent("//*[@id='formsContent']/div/div/a[text()='Hippa Notice of Privacy Practices']")
       .pause(500)
       .useCss()
       .click('a[href="/EHR/EHR/j_spring_security_logout"]')
       .waitForElementVisible('#username_id' , 60000)
...
'Admin login':function(browser){
	browser
       ...
       .click("//*[@id='formsContent']/div/div/a[text()='Hippa Notice of Privacy Practices']")
	   .useCss()
	   .waitForElementVisible('#acceptstatement_id' , 60000)
	   .pause(500)
	   .getLocationInView('#acceptstatement_id')
	   .pause(500)
	   .getLocationInView('#patientNameId')

...
'X-RAY Release':function(browser){
    browser
     .click('a[onclick="getAdminDefaultFormList();"]')
     .useXpath()
     .waitForElementVisible("//*[@id='adminDefaultFormsContent']/div/div/a[text()='X-RAY Release']" , 60000)
     .pause(500)
     ...
     .pause(1000)
        ...
        //.pause(800)
        .useXpath()
        .waitForElementNotPresent("//*[@id='adminDefaultFormsContent']/div/div/a[text()='X-RAY Release']" , 60000)
        .pause(500)
        
        .verify.elementNotPresent("//*[@id='adminDefaultFormsContent']/div/div/a[text()='X-RAY Release']")
        .pause(500)
        .useCss()
         .click('a[href="/EHR/EHR/j_spring_security_logout"]')
         .waitForElementVisible('#username_id' , 60000)

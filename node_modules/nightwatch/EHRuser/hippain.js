...
'check': function(browser){
  browser
    if([(symp.map(Number)).indexOf(9) > -1]=="false" ){
      browser
        .useCss()
        .pause(500)
        ...
        .pause(500)
        .useXpath()
        .click("//*[@id='symptom_description1']/option[10]")
        .useCss()
...
'Hip Questionnaire':function(browser){
    browser
	   .click('a[onclick="getDefaultFormList();"]')
	   .useXpath()
	   .waitForElementVisible("//*[@id='formsContent']/div/div/a[text()='Hip Questionnaire']" , 60000)
	   .pause(500)
	   .click("//*[@id='formsContent']/div/div/a[text()='Hip Questionnaire']")
	   .useCss()
...
'Fill Form':function(browser){	  
	...
	browser
     ...
     .click('input[name="upOrDownStairsLeftKnee"][value="'+upOrDownStairsLeftKnee+'"]')
	     ...
	     .useXpath()
         .pause(500)
         .verify.elementNotPresent("//*[@id='formsContent']/div/div/a[text()='Hip Questionnaire']")
         .pause(500)
         .useCss()
         .click('a[href="/EHR/EHR/j_spring_security_logout"]')
         .waitForElementVisible('#username_id' , 60000)
...
'Check 2':function(browser){
   browser	   
	   ...
	   .waitForElementVisible("//*[@id='formsContent']/div/div/a[text()='Confidential Patient Information']" , 60000)
	   .pause(1000)
              .getLocationInView("//*[@id='formsContent']/div/div/a[text()='Hip Questionnaire']")    
              .pause(2500)

...
'check': function(browser){
  browser
    if([(symp.map(Number)).indexOf(4) > -1]=="false" ){
      browser
        .useCss()
        .pause(500)
        ...
        .pause(500)
        .useXpath()
        .click("//*[@id='symptom_description1']/option[5]")
        .useCss()
...
'Mid Back Disability Questionnaire':function(browser){
    browser
	   .click('a[onclick="getDefaultFormList();"]')
	   .useXpath()
	   .waitForElementVisible("//*[@id='formsContent']/div/div/a[text()='Mid Back Disability Questionnaire']" , 60000)
	   .pause(500)
	   .click("//*[@id='formsContent']/div/div/a[text()='Mid Back Disability Questionnaire']")
	   .useCss()
...
'Fill Form':function(browser){	   
	...
	browser
	  ...
	  .useCss()
     .pause(500)
     .getLocationInView('#concentrationfair_id')
     .pause(500)
     ...
     .waitForElementVisible('a[onclick="getDefaultFormList();"]' , 60000)
	     ...
	     .useXpath()
         .pause(500)
         .verify.elementNotPresent("//*[@id='formsContent']/div/div/a[text()='Mid Back Disability Questionnaire']")
         .pause(500)
         .useCss()
         .click('a[href="/EHR/EHR/j_spring_security_logout"]')
         .waitForElementVisible('#username_id' , 60000)
...
'Check 2':function(browser){
   browser	   
	   ...
	   .waitForElementVisible("//*[@id='formsContent']/div/div/a[text()='Confidential Patient Information']" , 60000)
	   .pause(2000)
       .getLocationInView("//*[@id='formsContent']/div/div/a[text()='Mid Back Disability Questionnaire']")    
       .pause(2500)
       ...
       .getLocationInView('#_id')
       .pause(500)
       .midbackpain(painIntensity_1, personalCare_1, lifting_1, reading_1, headaches_1, concentration_1, work_1,driving_1, sleeping_1, recreation_1,

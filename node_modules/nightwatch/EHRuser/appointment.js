...
'Admin Login':function(browser){
  browser
   ...
   //do{
    ...
    .useCss()
    .pause(500)
    .getLocationInView('#appointment_next')
    .pause(500)
    .getLocationInView('a[class="red tooltipsclass"]')
    .pause(500)
    .click('#appointment_next' , function(result){})
    .pause(800)
           ...
           for(i=1; i<=result.value.length; i++){
                 browser
                    ...
                    .getText("//*[@id='appointment']/tbody/tr["+i+"]/td[4]" , function(result){
                      console.log('fffffffffffffffffffffffffffffffffff'+result.value)
                      console.log('appointment'+appointment_1)
                          if(result.value==appointment_1){
...
'Check':function(browser){
  browser
  .pause(500)
   .verify.equal(booking , appointment_1)
   browser
   .pause(500)
   .end()
